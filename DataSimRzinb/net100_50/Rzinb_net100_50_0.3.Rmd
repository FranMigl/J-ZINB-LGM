...
for (i in 1:length(SEED)){
  k_mat[[i]] <- k_net_datagen(net = net100, k = k, seed = SEED[i], n = 50, p = p, theta = 0.125, means = c(3,6,9), zerop = 0.3)
...
saveRDS(Xs_0.3, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/net100_n50_Xs_03.RDS")
...
saveRDS(net100_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_early_res_0.3.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_early_time_0.3.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/MEAN_grouped_early_res_0.3.RDS")
...
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_early_0.3_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/MEAN_grouped_early_0.3.pdf", width = 15, height = 15)
...
saveRDS(net100_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_res_0.3.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_time_0.3.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/MEAN_grouped_res_0.3.RDS")
...
```{r Plots}
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/grouped_0.3_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/DataSimRzinb/MEAN_grouped_0.3.pdf", width = 15, height = 15)
