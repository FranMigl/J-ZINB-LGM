...
saveRDS(Xs_0.1, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_n50_Xs_01.RDS")
saveRDS(Xs_0.3, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_n50_Xs_03.RDS")
```

Park Results

```{r}
parktime <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Simul_100_50/Park_time_late_0.1.RDS")

parkres <- readRDS(Park_net100_late, "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Simul_100_50/Park_late_res_0.1.RDS")
```
...
parklate <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Simul_100_50/late_nets_0.1.RDS")
...
parkearlytime <- readRDS(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Simul_100_50/Park_time_early_0.1.RDS")
parkearly <- readRDS(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Simul_100_50/Park_early_res_0.1.RDS")
...
saveRDS(net100_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/grouped_early_res_0.1.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/grouped_early_time_0.1.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/MEAN_grouped_early_res_0.1.RDS")
...
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net100_50/Single_Results/grouped_early_0.1_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net100_50/MEAN_grouped_early_0.1.pdf", width = 15, height = 15)
...
saveRDS(net100_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/grouped_res_0.1.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/grouped_time_0.1.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net100_50/MEAN_grouped_res_0.1.RDS")
...
```{r Plots}
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net100_50/Single_Results/grouped_0.1_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net100_50/MEAN_grouped_0.1.pdf", width = 15, height = 15)
