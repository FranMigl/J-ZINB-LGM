...
for (i in 1:length(SEED)){
  k_mat[[i]] <- k_net_datagen(net = net200, k = k, seed = SEED[i], n = 100, p = p, theta = 0.125, means = c(3,6,9))
...
saveRDS(Xs_0.1, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_n100_Xs_01.RDS")
...
running_time <- list()
Park_net200_late <- list()

for (i in seq_along(Xs_0.3)) {
  running_time[[i]] <- list()
  Park_net200_late[[i]] <- list()
  
  for (j in seq_along(Xs_0.3[[i]])) {
        running_time[[i]][[j]] <- system.time({
          Park_net200_late[[i]][[j]] <- docall_NBII_AND(Xs_0.3[[i]][[j]])
      })[3]
    }
}
# NB qui lo 0.3 in realtà è 0.1 in quanto generato con il precedente sistema di generazione dati
park_time <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Active_Cold_VS_Cold/timePark_late.RDS")

park_res <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Active_Cold_VS_Cold/Park_res_late.RDS")
```

```{r late fusion results}


late_nets <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Active_Cold_VS_Cold/late_nets")

# 
# pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Active_Cold_VS_Cold/Plots/MEAN_net200_PARK_late_AND.pdf", width = 15, height = 15)
# 
#   ggpubr::ggarrange(roc(mean_results_Park_late_ne200_0.1),
#           prc(mean_results_Park_late_ne200_0.1),
#           Accuracy(mean_results_Park_late_ne200_0.1),
#           F1_stat(mean_results_Park_late_ne200_0.1),
#           labels = c("A", "B", "C", "D"),
#           ncol = 2, nrow = 2)
# 
# dev.off()
...
# pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Active_Cold_VS_Cold/Plots/MEAN_net200_PARK_early_AND.pdf", width = 15, height = 15)
# 
#   ggpubr::ggarrange(roc(mean_results_Park_early_ne200_0.1),
#           prc(mean_results_Park_early_ne200_0.1),
#           Accuracy(mean_results_Park_early_ne200_0.1),
#           F1_stat(mean_results_Park_early_ne200_0.1),
#           labels = c("A", "B", "C", "D"),
#           ncol = 2, nrow = 2)
# 
# dev.off()
...
saveRDS(net200_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_early_res_0.1.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_early_time_0.1.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/metriche_grouped_early_0.1.RDS")
...
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/Single_Results/grouped_early_0.1_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/MEAN_grouped_early_0.1.pdf", width = 15, height = 15)
...
saveRDS(net200_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_res_0.1.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_time_0.1.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/MEAN_grouped_res_0.1.RDS")
...
```{r Plots}
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/Single_Results/grouped_0.1_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/MEAN_grouped_0.1.pdf", width = 15, height = 15)
