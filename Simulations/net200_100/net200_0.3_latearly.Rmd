...
saveRDS(Xs_0.3, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/net200_n100_Xs_03.RDS")
```

Xs_0.3 is now carrying a proper 0.3 zero inflation due to changes in the function for the drpout injection where we added a term related to the mean degree of the net. We have results on this parameter setting for various versions of our code, now we want to verify how does the Park algorithm work on these matrices for late and early fusion
...
for (i in 1:length(Xs_0.3)){
  running_time[[i]] <- system.time({
    net200_results[[i]] <- zinb_LGM_grp(Xs_0.3_early_list[[i]], sym = "AND", nCores = ncores, verbose = 1)
  })[3]
}

mean(sapply(running_time, function(x) x/60))

saveRDS(net200_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_early_res_0.3.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_early_time_0.3.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/metriche_grouped_early_0.3.RDS")
...
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/Single_Results/grouped_early_0.3_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/MEAN_grouped_early_0.3.pdf", width = 15, height = 15)
...
for (i in 1:length(Xs_0.3)){
  running_time[[i]] <- system.time({
    net200_results[[i]] <- zinb_LGM_grp(Xs_0.3[[i]], sym = "AND", nCores = ncores, verbose = 1)
  })[3]
}

mean(sapply(running_time, function(x) x/60))

saveRDS(net200_results, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_res_0.3.RDS")
saveRDS(running_time, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_time_0.3.RDS")
```

And here we explore the results
```{r results}
net200_results <- readRDS("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/grouped_res_0.3.RDS")
...
saveRDS(metriche_res, file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Simulations/net200_100/MEAN_grouped_res_0.3.RDS")
...
```{r Plots}
for(i in 1:length(SEED)){
pdf(file = paste0("/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/Single_Results/grouped_0.3_",i,".pdf"), width = 15, height = 15)
...
pdf(file = "/home/negus/Desktop/Link to Francesco/PhD Project/Scripts/Bisection_Grid/Plots/net200_100/MEAN_grouped_0.3.pdf", width = 15, height = 15)
